 ...
 * Tested with icc 13.
 */
#if (defined CALC_COUL_EWALD || CALC_COUL_ZMNZ) && defined __INTEL_COMPILER && defined GMX_SIMD_X86_AVX_256_OR_HIGHER
#define NBNXN_CUTOFF_USE_BLENDV
#endif
#endif
...
#define     rinv_ex_S3    rinv_S3
    ...
    frcoul_S1   = gmx_simd_mul_r(qq_S1, gmx_simd_fmadd_r(rsq_S1, gmx_simd_fmadd_r(rsq_S1, gmx_simd_fmadd_r(rsq_S1, mzq_7_S, mzq_5_S), mzq_3_S), rinv_ex_S1));
    ...
    frcoul_S3   = gmx_simd_mul_r(qq_S3, gmx_simd_fmadd_r(rsq_S3, gmx_simd_fmadd_r(rsq_S3, gmx_simd_fmadd_r(rsq_S3, mzq_7_S, mzq_5_S), mzq_3_S), rinv_ex_S3));
    ...
    vcoul_S1    = gmx_simd_mul_r(qq_S1, gmx_simd_add_r(rinv_ex_S1, gmx_simd_fmadd_r(rsq_S1, gmx_simd_fmadd_r(rsq_S1, gmx_simd_fmadd_r(rsq_S1, hzq_7_S, hzq_5_S), hzq_3_S), moh_zq_S)));
    ...
    vcoul_S3    = gmx_simd_mul_r(qq_S3, gmx_simd_add_r(rinv_ex_S3, gmx_simd_fmadd_r(rsq_S3, gmx_simd_fmadd_r(rsq_S3, gmx_simd_fmadd_r(rsq_S3, hzq_7_S, hzq_5_S), hzq_3_S), moh_zq_S)));
#endif
#endif
...
#else
    /* In ZM correction terms are added */
    ...
    frcoul_S1   = gmx_simd_mul_r(qq_S1, gmx_simd_fmadd_r(rsq_S1, gmx_simd_fmadd_r(rsq_S1, mzq_5_S, mzq_3_S), gmx_simd_fmadd_r(ewcorr_S1, brsq_S1, rinv_ex_S1)));
    ...
    frcoul_S3   = gmx_simd_mul_r(qq_S3, gmx_simd_fmadd_r(rsq_S3, gmx_simd_fmadd_r(rsq_S3, mzq_5_S, mzq_3_S), gmx_simd_fmadd_r(ewcorr_S3, brsq_S3, rinv_ex_S3)));
#endif
