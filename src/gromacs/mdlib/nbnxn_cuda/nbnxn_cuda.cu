...
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_noener_noprune_ptr[eelCuNR][evdwCuNR] =
{
    ...
    { nbnxn_kernel_ElecZMM_VdwLJ_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombGeom_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombLB_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJFsw_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJPsw_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombGeom_F_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombLB_F_cuda            }
};
...
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_ener_noprune_ptr[eelCuNR][evdwCuNR] =
{
    ...
    { nbnxn_kernel_ElecZMM_VdwLJ_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombGeom_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombLB_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJFsw_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJPsw_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombGeom_VF_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombLB_VF_cuda            }
};
...
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_noener_prune_ptr[eelCuNR][evdwCuNR] =
{
    ...
    { nbnxn_kernel_ElecZMM_VdwLJ_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombGeom_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombLB_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJFsw_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJPsw_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombGeom_F_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombLB_F_prune_cuda             }
};
...
static const nbnxn_cu_kfunc_ptr_t nb_kfunc_ener_prune_ptr[eelCuNR][evdwCuNR] =
{
    ...
    { nbnxn_kernel_ElecZMM_VdwLJ_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombGeom_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJCombLB_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJFsw_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJPsw_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombGeom_VF_prune_cuda,            nbnxn_kernel_ElecZMM_VdwLJEwCombLB_VF_prune_cuda            }
};
