            ...
            WriteMdpHeader writeMdpHeader, warninp_t wi)
{
    ...
    printStringNoNewline(&inp, "Constants for the zero-multipole summation method");
    ir->zmm_degree = get_eint(&inp, "zmm-degree", 2, wi);
    ir->zmm_alpha = get_ereal(&inp, "zmm-alpha", 0.0, wi);
