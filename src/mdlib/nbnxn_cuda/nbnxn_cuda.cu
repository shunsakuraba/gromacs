...
nb_default_kfunc_ptr[eelCuNR][nEnergyKernelTypes][nPruneKernelTypes] =
{
    ...
    { { k_nbnxn_zq,                         k_nbnxn_zq_prune },
      { k_nbnxn_zq_ener,                    k_nbnxn_zq_ener_prune } },
...
nb_legacy_kfunc_ptr[eelCuNR][nEnergyKernelTypes][nPruneKernelTypes] =
{
    ...
    { { k_nbnxn_zq_legacy,                  k_nbnxn_zq_prune_legacy },
      { k_nbnxn_zq_ener_legacy,             k_nbnxn_zq_ener_prune_legacy } },
